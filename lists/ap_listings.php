...
print <<<EOF
<div class="wrap">
<h2 title="viewlist">Listings Awaiting For Approval</h2>
...
$res = $this->get_nondisplayed_listings();
$i = 1;
...
print "<tr id=listing-$result[lstid] class=alternate>
	    ...
	    <td>$result[lstnm]</td>
            <td>$result[lstdsc]</td>
	    <td><a href=admin.php?page=wp-ttisbdir/main.php&approve=True&id=$result[lstid]>Approve</a></td>
